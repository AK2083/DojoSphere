...
describe('registerIpcHandlers', () => {
  it('registers all ipc channels', () => {
    ...
    expect(ipcMain.handle).toHaveBeenCalledWith('authorization:hasPermission', expect.any(Function))
    ...
    expect(ipcMain.handle).toHaveBeenCalledWith('associations:list', expect.any(Function))
    expect(ipcMain.handle).toHaveBeenCalledWith('associations:add', expect.any(Function))
    expect(ipcMain.handle).toHaveBeenCalledWith('associations:update', expect.any(Function))
    expect(ipcMain.handle).toHaveBeenCalledWith('associations:delete', expect.any(Function))
