...
export { getInitialLanguage } from './model/set-language/language-service'
export { getInitialTheme } from './model/set-theme/theme-service'
export { getThemeFromStorage, setThemeToStorage } from './model/set-theme/theme-storage'
