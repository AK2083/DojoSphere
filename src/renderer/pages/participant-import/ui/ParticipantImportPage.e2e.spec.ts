...
test.describe('ParticipantImportPage', { tag: '@regression' }, () => {
  test.beforeEach(async ({ page }) => {
    await setEnglishLanguage(page)
  })

  test('renders import page with stepper', { tag: ['@smoke', '@critical'] }, async ({ page }) => {
  ...
  test(
    'navigates from participant list via import button',
    { tag: '@critical' },
    async ({ page }) => {
