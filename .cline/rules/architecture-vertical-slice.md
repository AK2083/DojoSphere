---
description: Vertical Slice Architecture — layers, import rules, and slice structure for src/main and src/preload
...
- `main-window.ts` — `BrowserWindow`, preload path, DevTools rules
...
- Calls only `ipcRenderer.invoke` — **no** privileged decisions, no SQLite
